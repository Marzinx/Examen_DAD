          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header">
                <h5 class="m-0">Entrada <button class="btn btn-primary" onclick="nuevo()"><i class="fas fa-file"></i> Nuevo</button> <a href="" class="btn btn-success"><i class="fas fa-file-csv"></i> CSV</a></h5>
              </div>
              <div class="card-body">
                <div>
